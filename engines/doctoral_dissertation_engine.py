...
class DoctoralDissertationEngine(BaseReportEngine):
    ...
    def _report_type_profile(self):
        ...
        profile["missing"] += "\nFocus: Original scholarly research, high-level theoretical frameworks, and significant academic contribution."
        return profile
